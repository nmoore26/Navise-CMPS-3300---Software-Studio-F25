...
class MajorMinorTest {
    ...
    @Test
    void testMajorGraduationEligibility() {
        ...
        List<Course> sufficientCourses = Arrays.asList(
            math, cs, eng,
            new Course(301, "Algorithms", "Dr. White", 4, "CS301", "MWF", "1:00", "Gibson", 301, null),
            new Course(302, "Systems", "Dr. Black", 4, "CS302", "TTH", "2:30", "Stanley", 305, null),
            new Course(303, "Theory", "Dr. Green", 4, "CS303", "MWF", "3:00", "Jones", 201, null)
        );
    ...
    @Test
    void testMinorCreditLimitEnforcement() {
        Minor mathMinor = new Minor("Mathematics", 15);
        List<Course> withinLimit = Arrays.asList(math, cs, eng);
        List<Course> overLimit = Arrays.asList(math, cs, eng,
            new Course(401, "Advanced", "Dr. King", 4, "MATH401", "MWF", "9:00", "Gibson", 401, null),
            new Course(402, "Research", "Dr. Queen", 4, "MATH402", "TTH", "10:30", "Stanley", 402, null)
        );
    ...
    @Test
    void testStudentProgressTrackingWithMajor() {
    ...
    @Test
    void testStudentMinorCompliance() {
    ...
    @Test
    void testAdminCurriculumManagement() {
